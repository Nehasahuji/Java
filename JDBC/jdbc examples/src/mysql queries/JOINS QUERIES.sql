...
-- ----------------------------------------------CROSS JOIN----------------------------------------------------------------------
-- *************************************************************************************** SELECT ALL COLUMNS FROM BOTH THE TABLE
SELECT * FROM product CROSS JOIN product_category GROUP BY category_id;


-- ----------------------------------------------SELF JOIN ----------------------------------------------------------------------
-- ********************************************** JOIN A TABLE WITH ITSELF WE NEED TO ALIAS TABLE NAME OTHERWISE THROW EXCEPTIONS

SELECT * FROM product AS p1 
INNER JOIN  product AS p2 
ON p1.id=p2.id;
-- --------------------------------------------- DELETE JOIN -------------------------------------------------------------------
-- ****************************************************************************************** DELETE RECORDS FROM TABLE JOINTLY 
